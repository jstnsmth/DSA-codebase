...
# Include directories
INCLUDE_DIR = $(DATA_STRUCTURES_DIR) $(LINKED_LISTS_DIR)
...
$(BUILD_DIR)/main.o: $(MAIN_SRC) $(ARRAY_STATIC_HEADER) $(ARRAY_DYNAMIC_HEADER) $(SINGLY_LINKED_LIST_HEADER) | $(BUILD_DIR)
