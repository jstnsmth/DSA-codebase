...
ALGORITHMS_DIR = algorithms/searching
BUILD_DIR = build

# Include directories
INCLUDE_DIR = $(DATA_STRUCTURES_DIR) $(LINKED_LISTS_DIR) $(ALGORITHMS_DIR)
...
BINARY_SEARCH_HEADER = $(ALGORITHMS_DIR)/binarysearch.h
...
$(BUILD_DIR)/main.o: $(MAIN_SRC) $(ARRAY_STATIC_HEADER) $(ARRAY_DYNAMIC_HEADER) $(SINGLY_LINKED_LIST_HEADER) $(BINARY_SEARCH_HEADER) | $(BUILD_DIR)
